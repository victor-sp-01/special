export default (startDate = new Date(), endDate = new Date())=>{
    ...
    const diffmonth     = diffDate / month
    const diffweek      = diffDate / weeks
    const diffDay       = diffDate / days
    const diffHour      = diffDate / hours
    const diffMinutes   = diffDate / minutes
    const diffSecond    = diffDate / seconds
